...
<div class="input-group">
    <div class="form-control-plaintext"><a class="d-block" href="#">{$cron_url|escape:'htmlall':'UTF-8'}</a></div>
</div>
<div class="alert alert-info" style="margin-top: 10px;">
    ...
    <p style="margin-bottom: 0;"><strong>{l s='Example:' mod='omniversepricing'}</strong> {$cron_url|escape:'htmlall':'UTF-8'}?price_type=old_price</p>
</div>